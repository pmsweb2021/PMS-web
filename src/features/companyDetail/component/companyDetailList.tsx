...
const CompanyDetailList: React.FC<Props> = (props) => {
    return (
        <PbTable>
			...
			<PbBody>
				{props.loading && <TableSpinner colSpan={3} />}
				{!props.loading && !props.companyDetailList.length && <TableEmptyContainer colSpan={3} text={`No companyDetailList content found`} />}
